...
import {
  addSignificantMedicationsService,
  confirmAddMedicationService,
  getDashboardRemindersService,
  getMedicationByIdService,
  listAllActiveMedicationsService,
  markDoseTakenAndUpdateDashboardService,
  updateMedicationService,
  listHistoricalMedicationsService,
...
export const updateMedicationRecord = async (req, res, next) => {
  ...
  const result = await updateMedicationService(user, id, req.body);
...
export const listAllMedications = async (req, res, next) => {
  ...
  const result = await listAllActiveMedicationsService(patientId);
...
export const getMedicationById = async (req, res, next) => {
  ...
  const result = await getMedicationByIdService(id, patientId);
...
export const getDashboardReminders = async (req, res, next) => {
  ...
  const result = await getDashboardRemindersService(patientId);
...
export const markDoseTakenAndUpdateDashboard = async (req, res, next) => {
  ...
  const result = await markDoseTakenAndUpdateDashboardService(
    user,
    medicationId
  );
...
export const listHistoricalMedications = async (req, res, next) => {
  ...
  const result = await listHistoricalMedicationsService(patientId);
...
export const deleteMedication = async (req, res, next) => {
  ...
  const result = await deleteMedicationService(user, medicationId);
